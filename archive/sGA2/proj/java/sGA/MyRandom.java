...
public class MyRandom {
   ...
   // Return a random integer from low to high (inclusive).
   public static byte byteRandom(byte low, byte high) {
      byte nb = (byte)(high - low + 1);
      return (byte)(Math.random()*nb + low);
   }
   ...
   // Return a random byte from 1 to n inclusive.
   public static byte byteRandom(byte n) {
      return (byte)(Math.random()*n + 1);
   }
