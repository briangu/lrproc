abstract public class BitChromosome extends Chromosome { // genes are 0/1 (boolean)

   protected boolean[] bits = null;
	static 	Integer	myZero;
	static 	Integer	myOne;

   protected BitChromosome() { // construction only by subclasses
      super();
      bits = new boolean[chromosomeLength];
	myZero = new Integer(0);
	myOne = new Integer(1);
   }
   ...
   public Number getGene(int i) {
      return (Number) (bits[i]? myOne:myZero);
   }
